...
export const topProductData = [
  {
    name: "Blue Jacket",
    image: require(`../../assets/img/thumbs/thumb-7.jpg`),
    category: "Cloths",
    sales: 5930,
    status: "up",
  },
  {
    name: "White Sneaker",
    image: require(`../../assets/img/thumbs/thumb-12.jpg`),
    category: "Cloths",
    sales: 5177,
    status: "up",
  },
  {
    ...
    image: require(`../../assets/img/thumbs/thumb-14.jpg`),
    category: "Devices",
    sales: 4701,
    status: "down",
  },
  {
    name: "Apple Watch",
    image: require(`../../assets/img/thumbs/thumb-17.jpg`),
    category: "Devices",
    sales: 2833,
    status: "up",
  },
  {
    name: "Blue Backpack",
    image: require(`../../assets/img/thumbs/thumb-11.jpg`),
    category: "Bags",
    sales: 1692,
    status: "down",
  },
...
export const recentOrderData = [
  {
    id: "#5331",
    name: "Eileen Horton",
    image: require(`../../assets/img/avatars/thumb-1.jpg`),
    date: 1573430400,
    amount: 677,
    paymentStatus: "Paid",
    orderStatus: "Ready",
  },
  {
    ...
    image: require(`../../assets/img/avatars/thumb-2.jpg`),
    date: 1572393600,
    amount: 1328.35,
    paymentStatus: "Paid",
    orderStatus: "Ready",
  },
  {
    id: "#5321",
    name: "Ron Vargas",
    image: require(`../../assets/img/avatars/thumb-3.jpg`),
    date: 1593949805,
    amount: 629,
    paymentStatus: "Paid",
    orderStatus: "Shipped",
  },
  {
    id: "#5287",
    name: "Luke Cook",
    image: require(`../../assets/img/avatars/thumb-4.jpg`),
    date: 1579132800,
    amount: 25.9,
    paymentStatus: "Paid",
    orderStatus: "Shipped",
  },
  {
    id: "#5351",
    name: "Joyce Freeman",
    image: require(`../../assets/img/avatars/thumb-5.jpg`),
    date: 1591286400,
    amount: 817.5,
